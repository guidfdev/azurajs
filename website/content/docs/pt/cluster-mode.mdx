---
title: Cluster Mode
description: Escale sua aplicação através de múltiplos núcleos de CPU automaticamente
icon: Monitor
---
...
<Cards>
  <Card title="Configuração" href="/docs/pt/configuration" description="Aprenda todas as opções de configuração" />
  <Card title="Performance" href="/docs/pt/performance" description="Otimize sua aplicação ainda mais" />
