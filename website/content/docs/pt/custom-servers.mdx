...
<Cards>
  <Card title="Configuração" href="/docs/pt/configuration" description="Configure AzuraJS para qualquer runtime" />
  <Card title="Performance" href="/docs/pt/performance" description="Otimize para seu runtime" />
  <Card title="Exemplos" href="/docs/pt/examples" description="Veja mais exemplos práticos" />
</Cards>
