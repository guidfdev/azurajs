...
<Cards>
  <Card title="Routing" href="routing" description="Aprenda sobre padrões de rota e parâmetros" />
  <Card title="Decorators" href="decorators" description="Domine todos os decorators disponíveis" />
  <Card title="Middleware" href="middleware" description="Adicione middleware aos controllers" />
  <Card title="Validação" href="validation" description="Valide dados de requisição" />
</Cards>
